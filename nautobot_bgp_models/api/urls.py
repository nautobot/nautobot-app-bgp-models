...
router.register("peer-group-template-address-families", views.PeerGroupTemplateAddressFamilyViewSet)
router.register("peer-group-template-endpoints", views.PeerGroupTemplateEndpointViewSet)
