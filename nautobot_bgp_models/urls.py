...
urlpatterns = [
    ...
    path("peer-sessions/", views.PeerSessionListView.as_view(), name="peersession_list"),
    path("peer-sessions/add/", views.PeerSessionEditView.as_view(), name="peersession_add"),
    path("peer-sessions/<uuid:pk>/", views.PeerSessionView.as_view(), name="peersession"),
    path("peer-sessions/<uuid:pk>/edit/", views.PeerSessionEditView.as_view(), name="peersession_edit"),
    path("peer-sessions/<uuid:pk>/delete/", views.PeerSessionDeleteView.as_view(), name="peersession_delete"),
    path(
        "peer-sessions/<uuid:pk>/changelog/",
        ObjectChangeLogView.as_view(),
